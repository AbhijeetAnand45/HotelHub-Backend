...
public class BookingService implements IBookingService {
    ...
    public Response saveBooking(Long roomId, Long userId, Booking bookingRequest) {
        ...
        try {
            ...
            if (!roomIsAvailable(bookingRequest, existingBookings)) {
                throw new HandleException("Room not Available for selected date range");
            }
    ...
    public Response findBookingByConfirmationCode(String confirmationCode) {
        ...
        try {
        	Booking booking = bookingRepository.findByBookingConfirmationCode(confirmationCode).orElseThrow(() -> new HandleException("Booking not found"));
    ...
    public Response cancelBooking(Long bookingId) {
        ...
        try {
            bookingRepository.findById(bookingId).orElseThrow(() -> new HandleException("Booking Does Not Exist"));
