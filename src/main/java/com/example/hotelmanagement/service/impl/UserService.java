...
public class UserService implements IUserService {
    ...
    public Response register(User user) {
        ...
        try {
            ...
            if (userRepository.existsByEmail(user.getEmail())) {
                throw new HandleException(user.getEmail() + "Already Exists");
            }
    ...
    public Response login(LoginRequest loginRequest) {
        ...
        try {
            ...
            var user = userRepository.findByEmail(loginRequest.getEmail()).orElseThrow(() -> new HandleException("user Not found"));
    ...
    public Response getUserBookingHistory(String userId) {
        ...
        try {
            User user = userRepository.findById(Long.valueOf(userId)).orElseThrow(() -> new HandleException("User Not Found"));
    ...
    public Response deleteUser(String userId) {
        ...
        try {
            userRepository.findById(Long.valueOf(userId)).orElseThrow(() -> new HandleException("User Not Found"));
